...
import fb1 from "../image/facebook.png";
import ig1 from "../image/instagram.png";
import tt1 from "../image/twitter.png";
import wa1 from "../image/wa1.png";
  ...
  return (
    <>
      <div className="container-fluid main">
        ...
        <div className="container-fluid" data-aos="flip-up">
          <div className="row text-center">
            <div className="col-md-12">
              <h2 className="h21">We Connected With</h2>
            </div>
          </div>
          <div className="row text-center">
        ...
        <div className="container-fluid" data-aos="flip-up">
          <div className="row text-center">
            <b className="h11">આહીર શૈક્ષણિક ભવન સુરત</b>
          </div>
        </div>
